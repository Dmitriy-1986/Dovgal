...
socialMediaList.innerHTML += `<a href="${dataContact.linkedin.url}" title="${dataContact.linkedin.title}" class="social-media">${dataContact.linkedin.title}</a><br>`;
socialMediaList.innerHTML += `<a href="https://ru.stackoverflow.com/users/441480/dovgal-dima">
